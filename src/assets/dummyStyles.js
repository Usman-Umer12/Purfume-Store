...
export const bannerHomeStyles = {
  // Layout styles
  container: "relative overflow-x-hidden min-h-[95vh] flex flex-col",
  ...
  // Cards section
  cardsContainer: "relative w-full max-w-6xl mx-auto mt-1",
...
export const brandPageStyles = {
  ...
  // Watch Grid
  grid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6 relative z-10 mt-12",
...
export const footerStyles = {
  ...
  emailInput: "px-4 py-3 w-full rounded-t-lg sm:rounded-l-lg sm:rounded-r-none rounded-b-lg sm:mb-0 mb-3 border border-gray-300 focus:outline-none mt-8",
  subscribeButton: "px-6 py-3 bg-gradient-to-br from-gray-300 to-gray-500 text-white font-medium rounded-b-lg sm:rounded-r-lg sm:rounded-l-none rounded-t-lg transition-colors shadow-md hover:shadow-lg mt-8",
